...
generate_button = tk.Button(root, text="Generate Password", command=generate_password, bg="#59788E", fg="white")
generate_button.grid(row=2, column=0, columnspan=2, padx=10, pady=10, sticky="we")

reset_button = tk.Button(root, text="Reset", command=reset_password, bg="#F2B5E1", fg="white")
